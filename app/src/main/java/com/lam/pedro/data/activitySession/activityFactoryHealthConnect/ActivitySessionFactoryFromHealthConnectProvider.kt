...
object ActivitySessionFactoryFromHealthConnectProvider {
    private val factories: Map<Int, ActivitySessionFactoryFromHealthConnect> = mapOf(
        ...
        ExerciseSessionRecord.EXERCISE_TYPE_OTHER_WORKOUT to DriveSessionFactory(),
        ExerciseSessionRecord.EXERCISE_TYPE_OTHER_WORKOUT to ListenSessionFactory(),
        ExerciseSessionRecord.EXERCISE_TYPE_OTHER_WORKOUT to SitSessionFactory(),
