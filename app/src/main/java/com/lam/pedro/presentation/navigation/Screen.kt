...
enum class Screen(val route: String, val titleId: Int, val image: Int, val color: Color, val activityType: Int, val hasMenuItem: Boolean = true, ) {
    ...
    DriveSessionScreen("drive_screen", R.string.drive_screen, R.drawable.car_icon, Color(0xFF61a6f1), ExerciseSessionRecord.EXERCISE_TYPE_SURFING,false),
    ...
    SitSessionScreen("sit_session_screen", R.string.sit_session_screen, R.drawable.armchair_icon, Color(0xff71c97b), ExerciseSessionRecord.EXERCISE_TYPE_WHEELCHAIR, false),
    ListenSessionScreen("listen_session_screen", R.string.listen_session_screen, R.drawable.headphones_icon, Color(0xFF7199C9), ExerciseSessionRecord.EXERCISE_TYPE_GUIDED_BREATHING, false),
