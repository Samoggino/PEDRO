...
fun ListenSessionScreen(
    ...
    uiState: ListenSessionViewModel.UiState,
    onInsertClick: () -> Unit = {},
    ...
    LaunchedEffect(uiState) {
        ...
        if (uiState is ListenSessionViewModel.UiState.Uninitialized) {
            onPermissionsResult()
        }
        ...
        if (uiState is ListenSessionViewModel.UiState.Error && errorId.value != uiState.uuid) {
    ...
    Scaffold(
        ...
        if (uiState != ListenSessionViewModel.UiState.Uninitialized) {
            LazyColumn(
                modifier = Modifier
                    .fillMaxSize()
