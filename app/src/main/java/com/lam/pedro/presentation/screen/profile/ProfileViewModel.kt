...
class ProfileViewModel(context: Context) : ViewModel() {
    ...
    var firstName by mutableStateOf(sharedPreferences.getString("firstName", "FirstName") ?: "FirstName")
        private set
    var lastName by mutableStateOf(sharedPreferences.getString("lastName", "SecondName") ?: "SecondName")
        private set
    ...
    var height by mutableStateOf(sharedPreferences.getString("height", "Height") ?: "Height")
        private set
    var nationality by mutableStateOf(sharedPreferences.getString("nationality", "Nationality") ?: "Nationality")
        private set
