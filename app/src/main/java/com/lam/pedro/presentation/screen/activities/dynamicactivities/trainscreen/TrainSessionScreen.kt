...
fun TrainSessionScreen(
    ...
    uiState: TrainSessionViewModel.UiState,
    onInsertClick: () -> Unit = {},
    ...
    LaunchedEffect(uiState) {
        ...
        if (uiState is TrainSessionViewModel.UiState.Uninitialized) {
            onPermissionsResult()
        }
        ...
        if (uiState is TrainSessionViewModel.UiState.Error && errorId.value != uiState.uuid) {
    ...
    Scaffold(
        ...
        if (uiState != TrainSessionViewModel.UiState.Uninitialized) {
            LazyColumn(
                modifier = Modifier
                    .fillMaxSize()
