package com.lam.pedro.presentation.screen.recordlist
...
class RecordListScreenViewModel(
    ...
    private val seriesRecordsType: KClass<out Record> =
        SeriesRecordsType.stringToClass(seriesRecordsTypeString)
