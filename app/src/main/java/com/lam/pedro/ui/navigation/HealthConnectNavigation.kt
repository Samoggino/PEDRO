...
import com.lam.pedro.ui.screen.WelcomeScreen
import com.lam.pedro.ui.screen.changes.DifferentialChangesScreen
import com.lam.pedro.ui.screen.changes.DifferentialChangesViewModel
import com.lam.pedro.ui.screen.changes.DifferentialChangesViewModelFactory
import com.lam.pedro.ui.screen.exercisesession.ExerciseSessionScreen
import com.lam.pedro.ui.screen.exercisesession.ExerciseSessionViewModel
import com.lam.pedro.ui.screen.exercisesession.ExerciseSessionViewModelFactory
import com.lam.pedro.ui.screen.exercisesessiondetail.ExerciseSessionDetailScreen
import com.lam.pedro.ui.screen.exercisesessiondetail.ExerciseSessionDetailViewModel
import com.lam.pedro.ui.screen.exercisesessiondetail.ExerciseSessionDetailViewModelFactory
import com.lam.pedro.ui.screen.inputreadings.InputReadingsScreen
import com.lam.pedro.ui.screen.inputreadings.InputReadingsViewModel
import com.lam.pedro.ui.screen.inputreadings.InputReadingsViewModelFactory
import com.lam.pedro.ui.screen.privacypolicy.PrivacyPolicyScreen
...
fun HealthConnectNavigation(
  ...
  snackbarHostState: SnackbarHostState, // Cambiato da ScaffoldState a SnackbarHostState
) {
  ...
  NavHost(navController = navController, startDestination = Screen.WelcomeScreen.route) {
    ...
    composable(Screen.ExerciseSessions.route) {
      ...
      ExerciseSessionScreen(
        ...
        onError = { exception ->
          showExceptionSnackbar(snackbarHostState, scope, exception) // Aggiornato per utilizzare snackbarHostState
        },
        onPermissionsResult = {
